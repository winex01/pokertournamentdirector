...
?>
 ...
 -->  
        <ul class="list-group">
            <li class="list-group-item" style="font-size: 25px;"><b>EMPEROR CITY POKER</b></li>
            <li class="list-group-item text-right" ><span class="pull-left" style="font-size: 25px;"><strong>Players</strong></span><b style="font-size: 25px; color:black;"><input style="width:30px; border:0;" value="1" id="count">&nbsp&nbsp</b> 
                 <button type="button" class="btn btn-xs btn-success" id="moins" onclick="minus()"><i class="glyphicon glyphicon-minus"></i></button>
                 <button type="button" class="btn btn-xs btn-success" id="plus" onclick="plus()"><i class="glyphicon glyphicon-plus"></i></button>

            <li class="list-group-item text-right"><span class="pull-left" style="font-size: 25px;"><strong>Rebuys</strong></span><b style="font-size: 25px; color:black;"><input style="width:30px; border:0;" value="1" id="count1">&nbsp&nbsp</b> 
                <button type="button" class="btn btn-xs btn-success" id="moins1" onclick="minus1()"><i class="glyphicon glyphicon-minus"></i></button>
                 <button type="button" class="btn btn-xs btn-success" id="plus1" onclick="plus1()"><i class="glyphicon glyphicon-plus"></i></button></li>
             ...
             <ul class="list-group">
            <li class="list-group-item" style="font-size: 25px;"><b>CHIPS</b></li>
        ...
        <div class="col-sm-6">
                ...
                <center><span style="font-size: 45px; color:#ebc944;"><b>POKER TOURNAMENT DIRECTOR</b></span></center>
 ...
 -->
             ...
             <li class="list-group-item text-right"><span class="pull-left"><span class="pull-left" style="font-size: 30px;"><strong>{{$result->level}}</strong></span></span><b style="font-size: 30px; color:#0a0;">{{$result->blinds}}</b>
            </li>

            <li class="list-group-item text-muted">NEXT BLINDS:</li>
             <li class="list-group-item text-right"><span class="pull-left"><span class="pull-left" style="font-size: 20px; color: gray;"><strong>Level 2</strong></span></span><b style="font-size: 20px; color:gray;">50/100</b>
            </li>
            </ul>  
...
function run_clock(id,endtime){
  ...
  function update_clock(){
    ...
    if(t.total<=0){ 
      ...
      soundHandle.src = '{{asset('sound/alert.mp3')}}';
      soundHandle.play();
      document.getElementById("clockdiv").innerHTML = "<b><span class='tab blink' style='font-size: 150px; color:red;'>00:00</span></b>";
